...
const chainOptions: Record<number, chains.Chain> = {
...
const envChainId = Number(process.env.NEXT_PUBLIC_CHAIN_ID || chains.foundry.id);
const targetChain = chainOptions[envChainId] || chains.foundry;
